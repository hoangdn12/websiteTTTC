...
{?>
									...
									<strong>Chào mừng!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Hình ảnh sản phẩm1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Hình ảnh sản phẩm2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Hình ảnh sản phẩm3</label>
<div class="controls">
