					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									0.0<?php echo htmlentities($rws['productPrice']);?>VNĐ
								</span>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><?php echo htmlentities($row['productPrice']);?>VNĐ</span>
											<span class="price-strike"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>VNĐ</span>
										</div>
									</div>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Giá bán :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
													<div class="text"><b>Đánh giá :</b>  <?php echo htmlentities($rvw['value']);?> Star</div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Giá bán</td>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($rw['productPrice']);?>VNĐ 		</span>
										     <span class="price-before-discount">
										     <?php echo htmlentities($rw['productPriceBeforeDiscount']);?>VNĐ</span>
