...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo ""." ".$row['productPrice']; ?>VNĐ</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo ""." ".$row['shippingCharge']; ?>VNĐ</span></td>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Cập nhập</button>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Cập nhập</button>
					<?php } ?>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Đặt hàng</button>
